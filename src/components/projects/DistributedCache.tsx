...
export function DistributedCacheSlides({ project }: { project: any }) {
  return (
    <>
      <CarouselItem className="flex flex-col p-8 md:p-12">
        ...
        <p className="text-muted-foreground leading-relaxed flex-1">
          {project.description} A multi-region distributed caching layer leveraging Redis Cluster. Designed to reduce database read pressure and provide active-active failover capabilities across geographically distributed data centers.
        </p>
      </CarouselItem>
      ...
      <CarouselItem className="p-8 md:p-12 flex flex-col">
        ...
        <div className="flex-1 w-full bg-muted/30 rounded-xl flex items-center justify-center border border-border overflow-hidden relative shadow-inner">
          <span className="font-mono text-muted-foreground text-sm z-10">[ Topology Map ]</span>
        </div>
      </CarouselItem>
      ...
      <CarouselItem className="p-8 md:p-12 flex flex-col">
        ...
        <div className="flex flex-col gap-4 flex-1 justify-center max-w-md w-full">
          <div className="flex justify-between items-center border-b border-border pb-4">
            <span className="font-mono text-muted-foreground text-sm">Cache Hit Rate</span>
            <span className="font-mono text-lg font-semibold text-primary">94%</span>
          </div>
          <div className="flex justify-between items-center border-b border-border pb-4">
            <span className="font-mono text-muted-foreground text-sm">Replication Lag</span>
            <span className="font-mono text-lg font-semibold text-primary">&lt;2ms</span>
          </div>
        </div>
      </CarouselItem>
      ...
      <CarouselItem className="p-8 md:p-12 flex flex-col">
         ...
         <div className="flex flex-col gap-4 flex-1 justify-center max-w-xs mx-auto w-full">
           <Button variant="default" className="w-full font-mono font-bold tracking-wide">Design Doc</Button>
