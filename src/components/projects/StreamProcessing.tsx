...
export function StreamProcessingSlides({ project }: { project: any }) {
  return (
    <>
      <CarouselItem className="flex flex-col p-8 md:p-12">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          <Badge variant="secondary" className="font-mono">Flink</Badge>
          <Badge variant="secondary" className="font-mono">Kafka</Badge>
          <Badge variant="secondary" className="font-mono">Java</Badge>
        </div>
        <p className="text-muted-foreground leading-relaxed flex-1">
          {project.description} This ETL pipeline consumes raw CDC events from multiple relational databases, performs complex stateful aggregations, and sinks the enriched data into an OLAP datastore for real-time reporting.
        </p>
      </CarouselItem>
      ...
      <CarouselItem className="p-8 md:p-12 flex flex-col">
        ...
        <div className="flex-1 w-full bg-muted/30 rounded-xl flex items-center justify-center border border-border overflow-hidden relative shadow-inner">
          <span className="font-mono text-muted-foreground text-sm z-10">[ Flink DAG Visualization Placeholder ]</span>
        </div>
      </CarouselItem>
      ...
      <CarouselItem className="p-8 md:p-12 flex flex-col">
        ...
        <div className="flex flex-col gap-4 flex-1 justify-center max-w-md w-full">
          <div className="flex justify-between items-center border-b border-border pb-4">
            <span className="font-mono text-muted-foreground text-sm">Pipeline Lag</span>
            <span className="font-mono text-lg font-semibold text-primary">~200ms</span>
          </div>
          <div className="flex justify-between items-center border-b border-border pb-4">
            <span className="font-mono text-muted-foreground text-sm">Events Processed</span>
            <span className="font-mono text-lg font-semibold text-primary">2.5B / day</span>
          </div>
        </div>
      </CarouselItem>
      ...
      <CarouselItem className="p-8 md:p-12 flex flex-col">
         ...
         <div className="flex flex-col gap-4 flex-1 justify-center max-w-xs mx-auto w-full">
           <Button variant="default" className="w-full font-mono font-bold tracking-wide">Metrics Dashboard</Button>
